...
public class VentanaEditarEmpleado extends VentanaFormulario {
    ...
    public VentanaEditarEmpleado(String tituloVentana) {
        super(tituloVentana);
    }
    ...
    private void restringirCamposEditables() {
        ...
        this.opcionMasculino.setEnabled(false);
        this.opcionFemenino.setEnabled(false);
        this.opcionMatutino.setEnabled(false);
        this.opcionVespertino.setEnabled(false);
    }
